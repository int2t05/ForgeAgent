...
} from '@/modules/settings/types/mcp'
    ...
    <div className="space-y-4">
      <details className="group/full fa-card border-neutral-200/85 overflow-hidden open:shadow-sm">
        <summary className="cursor-pointer list-none px-4 py-2.5 font-medium text-base text-neutral-800 [&::-webkit-details-marker]:hidden">
          <span className="mr-2 inline-block text-neutral-500 transition-transform group-open/full:rotate-90">
            ▸
          </span>
          完整 JSON
        </summary>
      ...
      {servers.length === 0 && (
        <div className="fa-card border-dashed border-neutral-300/80 bg-[#f5f5f5]/50 px-4 py-6 text-center text-base text-neutral-500">
          暂无条目
        </div>
      )}
            ...
            <li key={s.localId}>
              <details className="fa-card group border-neutral-200/85 overflow-hidden open:shadow-sm">
                <summary className="flex cursor-pointer list-none items-center gap-2 px-4 py-2.5 text-base [&::-webkit-details-marker]:hidden">
                  <span className="text-neutral-500 select-none transition-transform group-open:rotate-90">
                    ▸
                  </span>
                  ...
                  <span className="fa-text-caption ml-auto font-display text-neutral-500 tabular-nums">
                    #{idx + 1}
                  </span>
                </summary>

                <div className="space-y-4 border-neutral-200 border-t px-4 py-4">
                  ...
                  {mode === 'json' ? (
                    ...
                    <>
                      ...
                      {s.transport === 'mock' && (
                        <div className="mt-2 border-neutral-200 border-t pt-4">
                          ...
                          <ul className="space-y-2">
                            {s.tools.map((t, ti) => (
                              <li key={`${s.localId}-tool-${ti}`}>
                                <details className="group/tool rounded-lg border border-neutral-200/80 bg-[#f5f5f5]/50 open:bg-white/60">
                                  <summary className="cursor-pointer list-none px-3 py-2 text-base [&::-webkit-details-marker]:hidden">
                                    <span className="mr-2 inline-block text-neutral-500 transition-transform group-open/tool:rotate-90">
                                      ▸
                                    </span>
                      ...
                      {s.transport === 'stdio' && (
                        <div className="mt-4 grid gap-3 border-neutral-200 border-t pt-4 sm:grid-cols-2">
                          <label className="block sm:col-span-2">
